...
if __name__ == '__main__':
    ...
    myBuilding = Building(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[3]))

    for i in range(int(sys.argv[6])):
        
        areas, walls = gen_3doors(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[4]), int(sys.argv[5]))
        
        f = Floor(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[3])/int(sys.argv[6]), i,areas, walls)
